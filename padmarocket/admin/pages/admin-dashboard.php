...
<div class="wrap pur-dashboard pur-page">
	<h2 class="dashboard-title" data-container="pur-content-wrap">Dashboard <a href="<?php echo add_query_arg( array( 'pur-action' => 'refresh' ), $this->model->url ); ?>" class="add-new-h2" data-action="refresh-data">Refresh data</a></h2>
	<div class="toolbar">
		<ul>
	...
	<div id="switcher" class="uk-switcher">
		<div><!-- dashboard -->
			<div class="uk-grid"><!-- grid -->
				...
				<div class="uk-width-large-1-3 btr-panel sign-up">
					...
					<div class="btr-panel-content">
						<p>Sign up to get notified when we release new Padma goodies and product updates.</p>
						<form action="http://Padmarocket.us5.list-manage.com/subscribe/post?u=5634a864e7429fd035bd71b21&amp;id=3a9b303fe3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
			...
			<div class="pur-add-ons-title-wrap"><!-- filter section -->
				<h3 class="subtitle">Add-ons</h3>
				<ul class="subsubsub pur-add-ons-filters">
					...
					<li class="inactive"><a href="<?php echo add_query_arg( array( 'addons_filter' => 'installed' ), $this->model->url ); ?>" class="pur-separator-left<?php if ( butler_get( 'addons_filter' ) == 'installed' ) echo ' active';?>">Installed <span class="count">(<?php echo count( $this->model->get_installed_components() ); ?>)</span></a></li>
					<li class="active"><a href="<?php echo add_query_arg( array( 'addons_filter' => 'active' ), $this->model->url ); ?>" class="pur-separator-left<?php if ( butler_get( 'addons_filter' ) == 'active' ) echo ' active';?>">Active <span class="count">(<?php echo count( $this->model->get_active_components() ); ?>)</span></a></li>
				</ul>
		...
		<div> <!-- settings -->
			<?php butler_options_meta_boxes( PADMAROCKET_PARENT_MENU ) ?>
		</div><!-- close settings -->
	</div>
</div>