...
class HwrApi {
    ...
    function __construct() {
        ...
        $this->api_url = "http://Padmarocket.com/api/Padmarocket/" . $this->version . "/api.php?output=php";
    ...
    function request_id( $method ) {
    	...
    	return 'padma_api_request_' . str_replace( '-', '_', $method );
